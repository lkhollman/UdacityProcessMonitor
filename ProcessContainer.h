...
class ProcessContainer{  //contains all of the processes

private:
    std::vector<Process>_list;  //variable is a vector of elements containing the type process
public:
    ProcessContainer(){
        this->refreshList();
    }
...
//this entire function is quite different in the video example and lesson example document
